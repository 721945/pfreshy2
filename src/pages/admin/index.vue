<template>
  <div class="content">
    ...
    <b-input type="text" v-model="form.sid"></b-input>รูป
    <b-input type="text" v-model="form.picture"></b-input>
...
export default {
  ...
  methods: {
    async addTodb() {
      ...
      try {
        const Res = await memberRef.set({
          ...this.form,
          realname: this.name1 + ' ' + this.name2,
        })
