        ...
        <b-navbar variant="faded" type="light" class="t">
            ...
            <ul class="ulNav">
              ...
              <li v-if="users">
                ...
                <div class="st" v-if="(users.role == 'staff')">
                  <nuxt-link :to="{ name: 'staff-id', params: { id: users.uid } }">หน้าใช้งาน</nuxt-link>
                </div>
              </li>
              <li v-if="users">
          ...
          <b-navbar-nav class="ml-auto">
            <div class="navbar" v-if="users">
              <span style="padding: 10px; margin: 0 10px;">สวัสดีคุณ {{ ' ' + users.name }}</span>
              <span
                v-if="users.role == 'member'"
            ...
            <div class="navbar" v-else>
              <nuxt-link to="/login">
                <b-button variant="outline-primary" class="login">LOGIN</b-button>
              </nuxt-link>
            </div>
          </b-navbar-nav>
        </b-navbar>
          ...
          <b-collapse id="navbar-toggle-collapse" is-nav>
            <b-navbar-nav class="ml-auto">
              ...
              <div v-if="users">
                ...
                <b-nav-item>
                  <div>
                    <nuxt-link to="/password" class="textDec">เปลี่ยนรหัสผ่าน</nuxt-link>
                  </div>
                </b-nav-item>
                <b-nav-item>
                  <a @click="signout" style="color: red;">LOGOUT</a>
                </b-nav-item>
              </div>
              <div v-else>
                <b-nav-item>
                  <nuxt-link to="/login" class="textDec">LOGIN</nuxt-link>
                </b-nav-item>
              </div>
            </b-navbar-nav>
          </b-collapse>
